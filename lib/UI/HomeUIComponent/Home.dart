...
import 'package:treva_shop_flutter/models/category_model.dart';
import 'package:treva_shop_flutter/models/product_model.dart';
...
class _MenuState extends State<Menu> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    var onClickWeekPromotion = (int percent) {
      Navigator.of(context).push(PageRouteBuilder(
    ...
    /// FlashSale component
    var FlashSell = FutureBuilder(
      future: APIService().getProducts(tagId: Config.flashSale),
      builder: (ctx, AsyncSnapshot<List<ProductModel>> flashProduct) {
        if (flashProduct.hasData) {
          return Container(
            height: 390.0,
                ...
                ...flashProduct.data
                    .map(
                      (flash) => Padding(
                        ...
                        child: flashSaleItem(
                          image: flash.images[0].src,
                          title: flash.name,
                          normalprice: flash.regularPrice,
                          discountprice: flash.salePrice,
                          ratingvalue: flash.averageRating,
                          stock: flash.stockQuantity.toString(),
                          colorLine:
                              flash.stockQuantity > 0 ? 0xffb8de6f : 0xffbb2205,
                          widthLine: 30.0,
                          place: 'Egypt',
                        ),
                      ),
    ...
    var Grid = FutureBuilder(
      future: APIService().getProducts(tagId: Config.recomended),
      builder: (ctx, AsyncSnapshot<List<ProductModel>> recomendedProduct) {
        if (recomendedProduct.hasData) {
                ...
                children: <Widget>[
                  ...
                  GridView.count(
                      ...
                      children: List.generate(
                        recomendedProduct.data.length,
                        (index) => ItemGrid(recomendedProduct.data[index]),
                      ))
                ],
              ),
            ),
...
class ItemGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(PageRouteBuilder(
            pageBuilder: (_, __, ___) => new detailProduk(productItem),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: NetworkImage(productItem.images[0].src),
                                fit: BoxFit.cover)),
                      ),
                    ),
                  ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        productItem.totalSales.toString(),
                        style: TextStyle(
                            fontFamily: "Sans",
                            color: Colors.black26,
                            fontWeight: FontWeight.w500,
