...
class detailProduk extends StatefulWidget {
  ...
  detailProduk(this.productItem);

  @override
  _detailProdukState createState() => _detailProdukState(productItem);
}
...
class _detailProdukState extends State<detailProduk> {
  ...
  _detailProdukState(this.productModel);
                        ...
                        child: Material(
                          child: new Carousel(
                            ...
                            images: productModel.images
                                .map((image) => NetworkImage(image.src))
                                .toList(),
                          ),
                        ),
                      ),
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      productModel.totalSales.toString(),
                                      style: TextStyle(
                                          color: Colors.black54,
                                          fontSize: 13.0,
                                          fontWeight: FontWeight.w500),
