...
class _brandDetailState extends State<brandDetail> {
  ...
  void initState() {
    ...
    //   var dar = await service.getProducts();
    //   print(dar);
    //   print('rrrr');
    // });
    print(brand.id);
    ...
    return EasyLocalizationProvider(
      ...
      child: Scaffold(
        ...
        body: FutureBuilder(
            ...
            builder: (context, AsyncSnapshot<List<ProductModel>> product) {
              if (product.hasData) {
                print('data');
                List<ProductModel> pickedData = product.data
                    .where((element) => element.categories[0].id == brand.id)
                    .toList();
                return SafeArea(
                                        ...
                                        buttonCustom(
                                          ...
                                          ontap: () {
                                            var snackBar = SnackBar(
                                              content: Text(brand.categoryName +
                                                  " Notificated"),
